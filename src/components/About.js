...
function About() {
    ...
    const techSkills = [
        {
            name: "JavaScript",
            icon: "/images/tech-stack-icons/js.png",
        },
        {
            name: "TypeScript",
        ...
        },
        {
            ...
            name: "Node.js",
            icon: "/images/tech-stack-icons/nodejs.png",
        },
        {
            name: "React",
            icon: "/images/tech-stack-icons/physics.png",
        },
        {
            name: "Next.js",
            icon: "/images/tech-stack-icons/next-js.jpg",
        },
        {
            name: "Tailwind CSS",
            icon: "/images/tech-stack-icons/png-transparent-tailwind-css-hd-logo.png",
        },
        {
            name: "GitHub",
            icon: "/images/tech-stack-icons/github.png",
        },
        {
            name: "Python",
            icon: "/images/tech-stack-icons/python.png",
        },
        {
            name: "Django",
            icon: "/images/tech-stack-icons/django-icon.jpg",
        },
        {
            name: "RESTful APIs",
            icon: "/images/tech-stack-icons/browser.png",
        },
        {
            name: "MySQL",
            icon: "/images/tech-stack-icons/mysql-database-web-development-computer-software-dolphin.jpg",
        },
        {
            name: "PostgreSQL",
            icon: "/images/tech-stack-icons/postgresql.jpg",
        },
        {
            name: "Command Line",
            icon: "/images/tech-stack-icons/command.png",
        },
        {
            name: "Docker",
            icon: "/images/tech-stack-icons/docker.png",
        },
        {
            name: "Redis",
            icon: "/images/tech-stack-icons/redis-icon.jpg",
        },
    ];
